...
def resolve_context_window(
    ...
    *,
    ...
    callable (typically backed by the provider model cache) used when no manual
    override exists. Returns :data:`DEFAULT_CONTEXT_WINDOW` when nothing is known,
    which callers treat as "no special handling needed".
    """
